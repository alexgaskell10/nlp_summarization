...
from resources import ROUGE_DIR, BASE_DIR, MODEL_WEIGHT_DIR, BLEURT_DIR
...
def evaluate_metric(metric, stem, remove_stop, prompt='overall'):
    ...
    if metric == 'bert-human':
        ...
        if 'base' in metric: 
            checkpoint = os.path.join(BLEURT_DIR, "bleurt/bleurt-base-512-ckpt")
        elif 'lg' in metric: 
